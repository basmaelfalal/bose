<template>
    <div class="nav-bar">
        <v-app-bar color="rgb(64, 79, 117)" prominent height="fit-content">
            <v-container fluid>
                <v-row style="margin-top: 0px;">
                    <v-col cols="3">
                        <img src="@/assets/images/11.png" alt="" style="width: 52px;height: 51px;" />
                    </v-col>
                    <v-col cols="5">
                        <input type="search" name="NavSearch" id="NavSearch" placeholder="search in store"
                            style="width: 100% ;color:white; border-radius:30px; outline:none; "
                    ...
                    <v-col cols="4">
                        <div class="parent text-white d-flex justify-space-between align-center">
                            <div class="available">
                                <span>
                                    Avalibale 24/7 at </span>
                                <br>
                                <strong>(090)123456</strong>
                            </div>
                            <div class="wishlist d-flex flex-column align-center">
                                <svg viewBox="0 0 512 512" class="icon icon-wishlist" style="width: 25px; fill:#ffb547">
                                    <g>
                                        <g>
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"></path>
                                ...
                                <span style="color: #ffb547;" class="mt-1">
                                    Wish Lists
                                </span>
                            </div>
                            <div class="wishlist d-flex flex-column align-center">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    style="width: 25px; fill:#ffb547" class="icon icon-account" viewBox="0 0 1024 1024"
                    ...
                    <v-col cols="5" class="d-flex justify-end" style="gap:50px;">
                        <div class="help d-flex align-center">


                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-headset"
                                role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                class="svg-inline--fa fa-user-headset fa-w-14 fa-3x" style="width: 25px; fill:#ffb547">

                                <path fill=""
                                    d="M320 352h-23.1a174.08 174.08 0
                                         0 1-145.8 0H128A128 128 0 0 0 0 480a32 32 0 0 0 32 32h384a32 32 0 0 0 32-32 128 128 0 0 0-128-128zM48 224a16 16 0 0 0 16-16v-16c0-88.22 71.78-160 160-160s160 71.78 160 160v16a80.09 80.09 0 0 1-80 80h-32a32 32 0 0 0-32-32h-32a32 32 0 0 0 0 64h96a112.14 112.14 0 0 0 112-112v-16C416 86.13 329.87 0 224 0S32 86.13 32 192v16a16 16 0 0 0 16 16zm160 0h32a64 64 0 0 1 55.41 32H304a48.05 48.05 0 0 0 48-48v-16a128 128 0 0 0-256 0c0 40.42 19.1 76 48.35 99.47-.06-1.17-.35-2.28-.35-3.47a64.07 64.07 0 0 1 64-64z"
                                    class=""></path>
                            </svg>
                        ...
                        <div class="lang text-white d-flex  align-center" style="gap:40px" id="language-btn">

                            <div style="display: inline-block;">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px"
                                    viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; width: 25px;"
