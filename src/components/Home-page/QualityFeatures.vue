<template>
    <div class="quality-features py-10 bg-grey-lighten-4">
        <v-container fluid="">
            <v-row>
                <v-col v-for="card in cards" :key="card.title" class="px-2">
                    <v-hover v-slot="{ isHovering, props}">
                    <v-card v-bind="props" class="text-center d-flex align-center justify-center" height="00" elevation="0" :color="isHovering ? 'blue-lighten-4' : 'white'"
                    style="cursor: pointer">
                        <div class="parent">
                            <span v-html="card.svg"></span>
                            <v-card-title style="font-size: 700">{{ card.title }}</v-card-title>
